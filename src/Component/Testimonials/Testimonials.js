...
const Testimonials = () => {
  ...
  return (
    <div className="testimonial-section py-5 px-5 bg-primary text-white">
      <div className="position-relative">
        <div className="">
          <div>
            <h2 className="ms-5 ps-5 mb-4">What people say about us</h2>
          </div>
        ...
        >
          <div className="carousel-inner">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div>
                  <div className="d-flex ms-5 ps-5 test ">
